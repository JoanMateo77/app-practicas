...
export default function LoginPage(){
    return(
        <main className="flex min-h-screen items-center justify-center
            ...
            <form className="w-full max-w-md space-y-6 rounded-2xl bg-white p-8
                                shadow-xl shadow-indigo-100 ring-1 ring-gray-200" onSubmit={handleLogin}>

                <h1 className="text-3xl font-bold text-center text-gray-800 ">Iniciar Sesion</h1>
                ...
                className="mt-1 w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500
